...
set seq_date=mar
:: set id=fixed_label_%seq_mode%_%seq_date%_loco%loco_class%_lm_testlm_fewknownclasses_dummy   
:: set id=fixed_label_%seq_mode%_%seq_date%_loco%loco_class%_lm_testlm_lessclass8_2_dummy
set id=dummy
